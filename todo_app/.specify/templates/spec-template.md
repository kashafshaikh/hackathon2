...
- **FR-003**: System MUST allow users to add, view, mark as complete, and delete todo items.
- **FR-004**: System MUST store todo items in-memory for the duration of the application's runtime.

### Key Entities *(include if feature involves data)*

- **Todo Item**: Represents a single task with attributes like description, status (e.g., pending, completed), and a unique identifier.
